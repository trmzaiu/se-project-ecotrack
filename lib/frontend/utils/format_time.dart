...
import 'package:wastesortapp/database/model/notification.dart';
...
List<Map<String, dynamic>> groupFromRawList(List<Notifications> list) {
  final Map<String, List<Notifications>> grouped = {};
