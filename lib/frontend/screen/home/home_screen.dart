                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Hộp xanh lá
                      Padding(
                        padding: EdgeInsets.only(top: 20, left: 25, right: 25), // Thay width cứng bằng right
                        child: Container(
                          height: 166,
                      ...
                      Padding(
                        padding: EdgeInsets.only(top: 20, left: 25), // Điều chỉnh khoảng cách xuống
                        child: SizedBox(
                          width: 176,
                          child: Text(
                            'Categories',
                                        ...
                                        TextSpan(
                                          children: [
                                            TextSpan(
                                              ...
                                              style: TextStyle(
                                                fontSize: 8,
                                                fontWeight: FontWeight.bold, // Chữ 100 in đậm
                                                color: Color(0xFF9C9385),
                                              ),
                                            ),
                                            TextSpan(
                                              ...
                                              style: TextStyle(
                                                fontSize: 8,
                                                fontWeight: FontWeight.normal, // Chữ attending không in đậm
                                                color: Color(0xFF9C9385),
                                              ),
                                            ),
                                          ],
