...
import 'package:wastesortapp/screens/tree/virtual_tree_screen.dart';
...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  late final Stream<List<Notif>> _notificationsStream;
  ...
  Widget buildNotificationItem(Notif notification) {
        ...
        children: [
          ...
          Expanded(
            child: Container(
              ...
              child: StreamBuilder<List<Notif>>(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: grouped.map((group) {
                            ...
                            final List<Notif> items = group['items'];
